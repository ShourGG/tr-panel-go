...
type Room struct {
	...
	// OnlinePlayers is computed from the current player presence table and is
	// deliberately not persisted in the rooms table.
	OnlinePlayers int        `json:"onlinePlayers" db:"-"`
